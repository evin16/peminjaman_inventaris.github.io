                ...
                <div class="container-fluid px-4">
                    ...
                    <div class="card mb-4">
                        <div class="card-header">
                            ...
                            <a class="btn btn-primary" href="form_peminjaman.php" role="button">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><?= $status; ?></td>
                                            <td>
                                                <button type="button" class="btn btn-sm" data-bs-toggle="modal" data-bs-target="#status<?= $idp; ?>" title="Status">
                                                    <i class="fas fa-exclamation-circle"></i>
                                                </button>
                                                <button type="button" class="btn btn-sm" data-bs-toggle="modal" data-bs-target="#hapus<?= $idp; ?>" title="Hapus">
                                                    <i class="fas fa-trash"></i>
                                                </button>
                                            </td>

                                            <!-- Modal Pengembalian Data -->
                                            <div class="modal fade" id="status<?= $idp; ?>">
                                                        ...
                                                        <form method="post">
                                                            <div class="modal-body">
                                                                <div class="form-floating mb-3">
                                                                    <p>Apakah <?= $nama_barang; ?> sudah dikembalikan?</p>
                                                                </div>
                                                                <input type="hidden" name="idp" value="<?= $idp; ?>">
                                                                <br>
                                                                <div class="d-grid">
                                                                    <button type="submit" class="btn btn-success" name="kembalian">Yakin</button>
                                                                </div>
                                                            </div>
                                                        </form>
                                                    </div>
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <form method="post">
                                                            <div class="modal-body">
                                                                <div class="form-floating mb-3">
                                                                    <p>Apakah data peminjaman <?= $nama_barang; ?> akan dihapus?</p>
                                                                </div>
                                                                <input type="hidden" name="idp" value="<?= $idp; ?>">
                                                                <br>
                                                                <div class="d-grid">
                                                                    <button type="submit" class="btn btn-success" name="hapuspinjam">Yakin</button>
                                                                </div>
                                                            </div>
                                                        </form>
                                                    </div>
                ...
                <form method="post">
                    <div class="modal-body">
                        <div class="form-floating mb-3">
                            ...
                            <label for="role">No Telp/Wa </label>
                        </div>
                        <div class="d-grid">
                            <button type="submit" class="btn btn-success" name="text">Kirim</button>
                        </div>
                    </div>
                </form>
            </div>
