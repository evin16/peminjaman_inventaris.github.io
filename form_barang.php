            ...
            <div id="layoutSidenav_nav">
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            <div class="sb-sidenav-menu-heading">Form Peminjaman</div>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Form Inventaris</h1>
                        
                        <div class="card mb-4">
                            <div class="card-header">
                                <!-- Tombol Kembali -->
                                <a class="btn btn-danger" href="inventaris.php" role="button">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                    <input type="text" class="form-control" name="jenisbarang" placeholder="Jenis Barang" required>
                                    </div>
                                </div>
                                <br>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                    <input type="number" class="form-control" name="totalbarang" placeholder="Jumlah Barang" required>
                                    </div>
                                </div>
                                <br>
                                <div class="form-group row">
                                    <label for="inputjenis" class="col-sm-2 col-form-label">Kondisi Barang</label>
                                    <div class="col-sm-10">
                                    <input type="text" class="form-control" name="kondisibarang" placeholder="Kondisi Barang" required>
                                    </div>
                                </div>
                                <br>
                                <div class="d-grid">
                                    <button type="submit" class="btn btn-primary" name="tambah_barang">Submit</button>
                                </div>
                                </form>
                            </div>
                        </div>
